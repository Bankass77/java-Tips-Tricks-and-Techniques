package com.java.trips.tricks.and.techniques.java10.typeinference;
...
public class TypeInferenceDemo_Basic {
    ...
    private static Logger logger = Logger.getLogger(TypeInferenceDemo_Basic.class.getName());
    ...
    public static void main(String[] args) {
        ...
        var employee = new com.java.trips.tricks.and.techniques.java9.collectionsAPiUpdate.Employee();
