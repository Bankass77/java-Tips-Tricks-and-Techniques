...
public class UnmodifiableMap {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, Employee> employeeMap3= Map.of(1, new Employee( 101, "Francesca Cescu"),
                2, new Employee( 102, "Emmanuel Macron"),
                3, new Employee( 103, "François Hollande"),
                4, new Employee( 104, "Jacques Chirac"),
                5 ,new Employee( 105, " François Mitterand"),
                6, new Employee(106, "Charles De Gaulle"));
        ...
        Map<Integer, Employee> employeeMap4 = Map.ofEntries( Map.entry(1, new Employee(101, "William Smith")),
