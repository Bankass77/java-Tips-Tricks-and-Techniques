...
public class UnmodifiableMap {
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, Employee> employeeMap2 = Map.of(1, new Employee(101, "Francesca Cescu"));

        Map<Integer, Employee> employeeMap3 = Map.of(1, new Employee(101, "Francesca ERETTT"), 2, new Employee(102, "Emmanuel Macron"), 3,
                new Employee(103, "François Hollande"), 4, new Employee(104, "Jacques Chirac"), 5, new Employee(105, " François Mitterand"), 6,
        ...
        Map<Integer, Employee> employeeMap4 = Map.ofEntries(Map.entry(1, new Employee(101, "William Smith")), Map.entry(2, new Employee(2, "Rakesh Ahuja")),
